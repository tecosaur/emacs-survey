...
# !!! Main.UserApp is configured as an alias for Main.EmacsSurvey and you might encounter it in some tests
using Main.EmacsSurvey, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "EmacsSurvey tests" begin
  @includetests ARGS
end
